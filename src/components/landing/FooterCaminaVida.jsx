      ...
      <div className="bg-slate-900 text-white rounded-[3rem] md:rounded-[4rem] overflow-hidden">
        ...
        <div className="hidden md:grid max-w-7xl mx-auto px-12 py-20 grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4 text-xl">
              <a
                href="#"
                className="p-2 bg-white/5 rounded-xl text-white hover:bg-[#FF5C35] transition-all duration-300"
              >
                <FaInstagram />
              </a>
              <a
          ...
          {/* NAVEGACIÓN */}
          <div>
            <h4 className="font-bold text-[#FF5C35] uppercase tracking-widest text-[10px] mb-6">
              Navegación
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-3 text-slate-300 text-sm">
              ...
              <li className="pt-2 italic text-slate-500 font-serif">
        ...
        <div className="md:hidden px-8 py-16 text-center space-y-10">
          ...
          <div className="flex justify-center gap-6">
            <a href="#" className="p-4 bg-white/5 rounded-2xl text-white">
              <FaInstagram size={24} />
            </a>
            <a href="#" className="p-4 bg-white/5 rounded-2xl text-white">
              <FaFacebook size={24} />
