      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl md:text-5xl font-serif text-slate-900 mb-6">
            Elegí tu ritmo de{" "}
            <span className="italic text-[#FF5C35]">bienestar</span>
          </h2>
          <p className="text-slate-500 font-light max-w-xl mx-auto">
            Planes flexibles diseñados para adaptarse a tu rutina y objetivos de
            salud.
          </p>
        </div>
          ...
          {planes.map((p, i) => (
            ...
            >
              ...
              <div className="mb-8">
                ...
                <p className="text-[#FF5C35] text-sm font-medium italic">
                  {p.frase}
                </p>
              </div>
              ...
              <ul className="space-y-4 mb-10 flex-grow">
                {p.detalles.map((detalle, idx) => (
                  <li
                    key={idx}
                    className="flex items-start gap-3 text-slate-600 text-sm font-light"
                  >
