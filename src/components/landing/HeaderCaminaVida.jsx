...
export default function HeaderCaminaVida() {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center">
          ...
          <div className="flex-none pr-10">
            <Link
              href="/"
              className="block transition-all duration-500 transform hover:scale-105"
            >
              <Image
                src="/logo.webp"
          ...
          <nav className="hidden md:flex items-center gap-8 flex-1">
            ...
            >
              <button
                className={`flex items-center gap-1.5 py-4 ${navLinkStyle}`}
              >
                Categorías de Caminatas
                <ChevronDown
                  size={14}
                  className={`transition-transform duration-300 ${openMega ? "rotate-180" : ""}`}
                />
              </button>
              ...
              >
                <div className="w-[750px] bg-white shadow-2xl rounded-[2.5rem] p-10 grid grid-cols-3 gap-10 border border-orange-50">
                  ...
                  <div className="space-y-4">
                    <h4 className="text-[10px] uppercase tracking-widest text-[#FF5C35] font-bold mb-6">
                      Bienestar
                    </h4>
                    <Link
                      href="/circuitos?categoria=terapeuticas"
                      className="flex items-center gap-3 text-slate-600 hover:text-[#FF5C35] transition group"
                    >
                      <Heart
                        size={18}
                        className="text-orange-200 group-hover:text-[#FF5C35]"
                      />
                    ...
                    <Link
                      href="/circuitos?categoria=meditativas"
                      className="flex items-center gap-3 text-slate-600 hover:text-[#FF5C35] transition group"
                    >
                      <Wind
                        size={18}
                        className="text-blue-200 group-hover:text-blue-500"
                      />
                      <span className="text-sm font-serif italic">
                        Meditativas
                      </span>
                    ...
                    >
                      <Activity
                        size={18}
                        className="text-emerald-200 group-hover:text-emerald-500"
                      />
                      <span className="text-sm font-serif italic">
                        Saludables
                      </span>
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      <Zap
                        size={18}
                        className="text-yellow-200 group-hover:text-yellow-500"
                      />
                      <span className="text-sm font-serif italic">
                        Fitness / Cardio
                      </span>
                    ...
                    >
                      <Mountain
                        size={18}
                        className="text-stone-300 group-hover:text-stone-600"
                      />
                      <span className="text-sm font-serif italic">
                        Aventura Alta
                      </span>
                    ...
                    <Link
                      href="/circuitos?categoria=exploracion"
                      className="flex items-center gap-3 text-slate-600 hover:text-[#FF5C35] transition group"
                    >
                      <Compass
                        size={18}
                        className="text-slate-300 group-hover:text-slate-800"
                      />
                      <span className="text-sm font-serif italic">
                        Exploración
                      </span>
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      <Sparkles
                        size={18}
                        className="text-amber-300 group-hover:text-amber-500"
                      />
                    ...
                    <Link
                      href="/circuitos?categoria=grupales"
                      className="flex items-center gap-3 text-slate-600 hover:text-[#FF5C35] transition group"
                    >
                      <Sun
                        size={18}
                        className="text-orange-200 group-hover:text-orange-500"
                      />
                      <span className="text-sm font-serif italic">
                        Sociales / Grupos
                      </span>
                    ...
                    <Link
                      href="/circuitos"
                      className="flex items-center gap-3 text-[#FF5C35] font-bold hover:translate-x-1 transition-transform"
                    >
                      <Map size={18} />
            ...
            <Link href="/#beneficios" className={navLinkStyle}>
              Beneficios
            </Link>
            <Link href="/#metodo" className={navLinkStyle}>
              Nuestro Método
            </Link>
          </nav>
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link href="/#planes" className={navLinkStyle}>
              Planes
            </Link>
            <Link
              href="/reservar/1"
      ...
      <aside
        className={`fixed top-0 right-0 h-full w-80 bg-[#FFFBF7] shadow-2xl z-[70] p-10 transform transition-transform duration-500 ease-out ${
      ...
      >
        <div className="flex justify-between items-center mb-12">
          ...
          <button
            ...
            className="text-slate-400 hover:text-[#FF5C35]"
          >
            <X size={32} />
          </button>
        </div>
