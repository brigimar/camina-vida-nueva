  ...
  return (
    <main className="min-h-screen bg-white flex flex-col items-center justify-center px-6 py-16">
      ...
      <p className="text-gray-700 mb-6 text-center max-w-lg">
        ...
        <strong>{inscripcion.circuito_nombre}</strong>. Te esperamos en la
        próxima caminata.
      </p>

      <div className="bg-gray-100 p-6 rounded-lg shadow max-w-md w-full mb-8">
        <p>
          <strong>Nombre:</strong> {inscripcion.nombre} {inscripcion.apellido}
        </p>
        <p>
          <strong>Email:</strong> {inscripcion.email}
        </p>
        <p>
          <strong>Teléfono:</strong> {inscripcion.telefono}
        </p>
        <p>
          <strong>Circuito:</strong> {inscripcion.circuito_nombre}
        </p>
        <p>
          <strong>Localidad:</strong> {inscripcion.localidad}
        </p>
        <p>
          <strong>Días:</strong> {inscripcion.dias?.join(", ")}
        </p>
        <p>
          <strong>Horarios:</strong> {inscripcion.horarios?.join(", ")}
        </p>
      </div>
