...
export default async function SesionesShow({ params }: Props) {
  ...
  const cRes = await supabase.from('circuitos').select('*').eq('id', sesion.circuito_id).single();
